...
{% include figure image_path="/assets/images/dg_robot.PNG" alt="The robot from DeGraded" caption="DEGaS, the protagnist of DeGraded. Modeled by the talented Stoney Jimenez"%}
...
And full credits and a download for Mac and Windows [here](https://tiagoros.itch.io/degraded).
